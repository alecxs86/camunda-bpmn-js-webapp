...
export default {
    ...
    "Create Gateway": "Crear Pasarela",
    "Create Task": "Crear Tarea",
    "Create PathwayActionTask": "Crear Tarea de acción de vía clínica",
    "Create DataObjectReference": "Crear Referencia de objeto de datos",
    "Create DataStoreReference": "Crear Referencia del almacén de datos",
    ...
    "no parent for {element} in {parent}": "no padre para {element} en {parent}",
